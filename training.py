...
if __name__ == "__main__":
    ...
    for epoch in range(1, iteration):
        ...
        if AUC_test>= 0.98  and precision_test>=0.96  and recall_test> 0.94:
              torch.save(model.state_dict(), f'./result/AUC_{AUC_test}_Pre_{precision_test}_Recall_{recall_test}.model')
