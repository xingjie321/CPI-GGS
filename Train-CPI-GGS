...
if __name__ == "__main__":
    ...
    for epoch in range(1, iteration):
        ...
        if AUC_test>= 0.968  and precision_test>=0.94  and  PRC_test>0.9 and recall_test> 0.92:
              torch.save(model.state_dict(), f'./result/AUC_{AUC_test}_PRC_{PRC_test}_Pre_{precision_test}_Recall_{recall_test}.model')
